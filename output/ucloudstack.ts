...
// Generated with design-token-editor on 2024/10/17 14:51:21
...
module.exports = {
    ...
    // 按钮/备用/边框/hover
    T_BUTTON_OTHER_COLOR_BORDER_HOVER: '#355EB9',
    // 按钮/备用/投影/默认
    T_BUTTON_OTHER_COLOR_SHADOW_DEFAULT: '0 0 0 0 rgba(0,0,0,0.12),inset 0 0 0 0 #c1d4fa',
    // 按钮/备用/投影/hover
    T_BUTTON_OTHER_COLOR_SHADOW_HOVER: '0 0 0 0 rgba(0,0,0,0.12),inset 0 0 0 0 #c1d4fa',
    // 按钮/主/背景色
    ...
    // 按钮/次/投影/默认
    T_BUTTON_SECONDARY_COLOR_SHADOW_DEFAULT: '0 2px 3px 0 rgba(0,0,0,0.12),inset 0 -2px 0 0 #c1d4fa',
    // 按钮/次/投影/hover
    ...
    // 标题/字体颜色
    T_CARD_HEADER_FONT_COLOR_DEFAULT: '#1c2e64',
    // 标题/字体粗细
    ...
    // 二级标题/字体颜色
    T_CARD_SECONDARY_FONT_COLOR_DEFAULT: '#1c2e64',
    // 二级标题/字体粗细
    ...
    T_LINE_WIDTH_SM: '0px',
    // 列内容文本颜色/文本/常规/深色
    T_LIST_CONTENT_FONT_COLOR_DEFAULT: '#1c2e64',
    // 列内容文本颜色/文本/备注/深色
    ...
    // 排版link中icon的hover颜色
    T_TYPOGRAPHY_ICON_LINK_HOVER: '#355EB9',
    // 一般用于备注/正文，是浏览器识别的最小字号
