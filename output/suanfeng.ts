...
module.exports = {
    ...
    // 按钮/备用/边框/hover
    T_BUTTON_OTHER_COLOR_BORDER_HOVER: '#001D3D',
    // 按钮/备用/投影/默认
    T_BUTTON_OTHER_COLOR_SHADOW_DEFAULT: '0 0 0 0 rgba(0,0,0,0.12),inset 0 0 0 0 #BFDCFC',
    // 按钮/备用/投影/hover
    T_BUTTON_OTHER_COLOR_SHADOW_HOVER: '0 0 0 0 rgba(0,0,0,0.12),inset 0 0 0 0 #BFDCFC',
    // 按钮/主/背景色
    ...
    // 按钮/次/投影/默认
    T_BUTTON_SECONDARY_COLOR_SHADOW_DEFAULT: '0 2px 3px 0 rgba(0,0,0,0.12),inset 0 -2px 0 0 #BFDCFC',
    // 按钮/次/投影/hover
    ...
    // 排版link中icon的hover颜色
    T_TYPOGRAPHY_ICON_LINK_HOVER: '#001D3D',
    // 一般用于备注/正文，是浏览器识别的最小字号
